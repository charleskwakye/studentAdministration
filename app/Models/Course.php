...
class Course extends Model
{
    ...
    public function programme(){
        return $this->belongsTo(Programme::class)->withDefault(); // a course belongs to a programme
    }

    public function student_courses(){
        return $this->hasMany(StudentCourse::class); //a course has many student_courses
    }
    ...
    public function scopeSearchCourseNameOrProgramme($query,$search){
