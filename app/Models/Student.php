...
class Student extends Model
{
    ...
    public function student_courses(){
        return $this->hasMany(StudentCourse::class);// a student has many student_course
    }

    public function programme(){
        return $this->belongsTo(Programme::class)->withDefault(); // a student belongs to a programme
    }
