...
class StudentCourse extends Model
{
    ...
    public function student(){
        return $this->belongsTo(Student::class)->withDefault(); // a student_course belongs to a student
    }

    public function course(){
        return $this->belongsTo(Course::class)->withDefault(); // a student_course belongs to a course
    }
